...
/**
 * OpenAI API Helper
 * Handles communication with OpenAI API for natural language to SQL conversion
 */
...
class OpenAIHelper {
    ...
    public function __construct() {
        ...
        $this->maxTokens = (int)(getenv('OPENAI_MAX_TOKENS') ?: 2000);
        $this->temperature = (float)(getenv('OPENAI_TEMPERATURE') ?: 0.1);
