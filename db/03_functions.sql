...
-- Description: Calculate overall satisfaction score for a hotel (0-100)
-- Parameters: p_hotel_id (INT) - Hotel ID
-- Returns: DECIMAL - Satisfaction score (0-100)
-- Formula: 70% rating + 20% review volume + 10% response rate
-- Example: SELECT CalculateGuestSatisfactionScore(1);
-- ============================================================================
